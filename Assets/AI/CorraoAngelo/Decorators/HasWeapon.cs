...
{
    public class HasWeapon : Node
    {
		protected Node childNode;
		private Inventory.Inventory inventory;

		public HasWeapon(Node childNode, Inventory.Inventory inventory, ref BlackBoard blackboard, List<BreakConditions> breakConditions = null)
